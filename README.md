...
If you're running your own Supabase instance, simply set `api_url` to your self-hosted address (e.g. `http://192.168.1.100:8000`). No additional configuration is needed.
